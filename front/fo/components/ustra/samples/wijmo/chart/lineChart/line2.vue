<template>
  <v-card>
    <template #title> 누적라인차트 </template>
    <template #subtitle> LineMaker 활용하여 누적차트 구현 </template>
    <template #text>
      <WjFlexChart
        :itemsSource="data"
        tooltipContent=""
      ...
      <UMarkdownViewer>{{ line2 }}</UMarkdownViewer>
    </template>
  </v-card>
</template>
...
import { useWijmoChart } from '#ustra/nuxt-wijmo/composables'
import { UMarkdownViewer } from '#ustra/nuxt/components'

// @ts-ignore
import line2 from './md/line2.md'
