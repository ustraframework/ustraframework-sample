<template>
  <v-card>
    <template #title> 기본라인차트 </template>
    <template #subtitle>
      WjFlexChart, WjFlexChartLegend, WjFlexChartAxis, WjFlexChartSeries, WjFlexChartAnimation 활용하여 기본 라인차트 구현
    </template>
    <template #text>
      <WjFlexChart
        :itemsSource="data"
      ...
      <UMarkdownViewer>{{ line1 }}</UMarkdownViewer>
    </template>
  </v-card>
</template>
