<template>
  <v-card>
    <template #title> 그리드 로우 드래그 </template>
    <template #subtitle> 로우 드래그 드롭시 이벤트 처리 방법에 대하여 설명한다. </template>
    <template #text>
      ...
      <UMarkdownViewer>{{ rowDrag1 }}</UMarkdownViewer>
    </template>
  </v-card>
</template>
...
import rowDrag1 from './md/row-drag1.md'
