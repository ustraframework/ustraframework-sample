<template>
  <VCard>
    <template #title>Cell Selection</template>
    <template #subtitle> selectionMode를 "Cell"로 설정하여 단일 Cell을 선택하도록 설정할 수 있다. </template>
    <template #text>
      ...
      <UMarkdownViewer :content="selection3" />
    </template>
  </VCard>
</template>
...
// @ts-ignore
import selection3 from './md/selection3.md'
