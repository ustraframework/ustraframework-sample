<template>
  <VCard>
    <template #text>
      UUserPopup 컴포넌트를 사용하여 사용자를 팝업을 통해 선택할 수 있다. 사용자 선택이 완료되면 selected 이벤트가 발생되며 첫번째 인자 값으로 선택된
      사용자 정보가 반환된다.
      <br /><br />

      <VBtn @click="() => (showPopup = true)">팝업오픈</VBtn>
      <UVUserPopup v-model="showPopup" @selected="data => (selectedItem = data)" />
      ...
      <!-- <UMarkdownViewer :content="userPopup1" /> -->
    </template>
  </VCard>
</template>
