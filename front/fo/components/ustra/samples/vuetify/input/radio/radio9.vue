<template>
  <v-card>
    <template #text>
      ...
      <UVRadioGroupBox v-model="radioValue" :itemsSource="items2" />
      <br />

      <!-- <UMarkdownViewer :content="doc1" /> -->
      <!-- <UVRadioGroupBox v-model="radioValue" :itemsSource="items">
      ...
      <!-- <UVRadioGroupBox v-model="radioValue2" :itemsSource="items" contentTemplate="custom">
