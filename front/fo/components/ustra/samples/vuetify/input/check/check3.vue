<template>
  <v-card>
    ...
    <template #subtitle> Vuetify utility class 사용</template>
    <template #text>
      <h3>direction</h3>
      direction 속성을 사용하여 하위 아이템의 방향 변경할 수 있다. <br />
      - row : 아이템을 줄 기준으로 (기본 값) <br />
      - column : 아이템을 줄이 쌓이는 형태로 <br /><br />
