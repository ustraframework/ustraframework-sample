      ...
      <UBox direction="row" style="gap: 5px">
        <UItem :ratio="6">
          <WjFlexGrid style="height: 600px" :initialized="gridAction.histGrid.initialize">
            ...
            <WjFlexGridColumn binding="deptCd" header="부서명" width="*" :cellTemplate="ctx => useUstraCodeValue('DEPT_CD', ctx.value)" />
            <WjFlexGridColumn binding="authYn" header="권한 사용 여부" width="*" />
            <WjFlexGridColumn binding="workDvCd" header="작업구분" width="*" :cellTemplate="ctx => useUstraCodeValue('WORK_DV_CD', ctx.value)" />
            <WjFlexGridColumn
              binding="regDttm"
              header="등록 일시"
              width="*"
