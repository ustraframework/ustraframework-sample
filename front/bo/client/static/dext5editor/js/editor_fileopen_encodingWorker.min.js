...
new FileReader;l.onload=function(a){postMessage({result:this.result,hasBom:g});l=void 0};l.readAsText(b,c)}catch(p){postMessage({result:"[DEXT5Error] "+p.message,hasBom:!1})}},!1);
